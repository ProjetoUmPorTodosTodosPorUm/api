...
export const IsNumberString = (numericOptions?: ValidatorJS.IsNumericOptions, options?: ValidationOptions) =>
	_IsNumberString(
		{ ...numericOptions },
		{
			...options,
...
export const IsDateString = (dateOptions?: ValidatorJS.IsISO8601Options, options?: ValidationOptions) =>
	_IsDateString(
		{ ...dateOptions },
		{
			...options,
...
export const IsUUID = (version?: ValidatorJS.UUIDVersion, options?: ValidationOptions) =>
	_IsUUID(version, {
		...options,
