...
import { ApiBatchResponse, ApiBooleanResponse, ApiResponse, User as Jwt } from 'src/utils'
...
export class UserController {
	...
	@ApiResponse(CreateUserDto)
	@Put(':id')
	update(@Param('id') id: string, @Jwt() user: User, @Body() updateUserDto: UpdateUserDto) {
