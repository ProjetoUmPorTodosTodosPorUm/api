...
export class RecoveryHouseController {
	...
	@Post()
	create(@Jwt() user: User, @Body() createRecoveryHouseDto: CreateRecoveryHouseDto) {
	...
	@ApiResponse(CreateRecoveryHouseDto)
	@Put(':id')
	update(@Param('id') id: string, @Jwt() user: User, @Body() updateRecoveryHouseDto: UpdateRecoveryHouseDto) {
