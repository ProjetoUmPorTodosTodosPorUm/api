...
describe('Announcement Service Integration', () => {
  ...
  describe('create()', () => {
    ...
    it('Should Not Create an Event (as WEB MASTER && Missing Data)', async () => {
      try {
        await announcementService.create(webMaster, {
          title,
          message,
        });
      } catch (error) {
  ...
  describe('update()', () => {
    ...
    it('Should Not Update an Announcement (Different Field as USER)', async () => {
      try {
        ...
        await announcementService.update(announcement.id, user,
          { title: newTitle },
        );
      } catch (error) {
    ...
    it('Should Not Update an Announcement (Different Field as ADMIN)', async () => {
      try {
        ...
        await announcementService.update(announcement.id, admin,
          { title: newTitle },
        );
      } catch (error) {
        expect(error).toBeInstanceOf(ForbiddenException);
